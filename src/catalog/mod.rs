...
pub use chunk::{
    CitePayload, FloatListSource, InlineKind, InlineSpan, ListKind, NoteKind, OrderedListNumbering,
    PendingNote, TEXT_HEADER_MAX_BYTES, TableCell, TableData, TableRow, TextAlign, TextHeader,
    TextRole, decode_text_payload, encode_text_payload, encode_u32_prefixed, split_u32_prefixed,
};
